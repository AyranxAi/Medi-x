...
>
> ⚠️ **THIS BLOCK PREDATES ROUND 20** (the doctors' phone rail and the section's single
> pill, 2026-08-19). Where it describes a pill under each doctor's name, read the round
> 20 section below — the rest of it still stands.
>
...
## Round 20 — the doctors turn sideways, and four pills become one (2026-08-19)
