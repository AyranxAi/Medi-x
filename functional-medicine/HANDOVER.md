...
>
> ⚠️ **THIS BLOCK PREDATES ROUND 4** (the doctors' phone rail and the section's single
> pill, 2026-08-19). Where it describes a pill under each specialist's name, read the
> round 4 section at the foot of this file — the rest of it still stands.
>
...
## Round 4 — the doctors turn sideways, and four pills become one (2026-08-19)
...
**Nothing about Ms. Richa Puri's card or her chooser row changed** — she keeps her slot,
her portrait and her client copy, and this page's *"The specialists you'll meet"* /
*"Choose who you'll see"* wording (the regulatory correction from round 3) stands. The one
pill's label is *"Book a consultation"* on all three pages, which is the service-neutral
form and needs no equivalent split.
